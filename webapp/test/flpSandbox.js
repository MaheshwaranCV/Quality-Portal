		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#maheshqualityportal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"maheshqualityportal-display": {
								"semanticObject": "maheshqualityportal",
								"action": "display",
								"description": "Quality Portal",
								"title": "Quality Portal",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=maheshqualityportal",
									"url": sap.ui.require.toUrl("maheshqualityportal")
								}
							}
						}
					}
